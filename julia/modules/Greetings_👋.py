...
async def cbot(event):
    ...
    try:      
      ...
      await tbot.edit_message(event.chat_id, tid, "See the above image and press the exact button corresponding to the number in the image", file="checkbot.png", buttons=button)
...
async def checkbot(event):
    ...
    if cnum == onum:
      try:
       ...
       await tbot.edit_message(event.chat_id, msgid, "Yep you are verified as a human being, you are unmuted in that chat.")
      except Exception:
       ...
       await tbot.edit_message(event.chat_id, msgid, "See the above image and press the exact button corresponding to the number in the image", file="checkbot.png", buttons=button)
